# Fabric Drawer
[![CurseForge](https://curse.nikky.moe/api/img/334410)](https://curseforge.com/minecraft/mc-mods/fabric-drawer)
...
dependencies {
    // [...]
    modImplementation("com.lettuce.fudge:fabric-drawer:1.1.0-RC-1")
}
```
